...
[Unit]
Description=ObsTester App-A Service

[Service]
Environment=SVCNAME=app-a
...
127.0.0.2 app-b.ns-b.svc.cluster.local
  ...
  custom:
    ...
    - plugin:
        ...
        - name: SAMPLE_JWT_ATTRIBUTES
          value: "instance_name=vm1,instance_role=app-a,region=region1"
