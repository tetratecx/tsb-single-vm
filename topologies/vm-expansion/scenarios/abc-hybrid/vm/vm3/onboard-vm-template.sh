...
[Unit]
Description=ObsTester App-C Service

[Service]
Environment=SVCNAME=app-c
  ...
  custom:
    ...
    - plugin:
        ...
        - name: SAMPLE_JWT_ISSUER
          value: "https://issuer-vm3.demo.tetrate.io"
        ...
        - name: SAMPLE_JWT_SUBJECT
          value: "vm3.demo.tetrate.io"
        - name: SAMPLE_JWT_ATTRIBUTES_FIELD
          value: "custom_attributes"
        - name: SAMPLE_JWT_ATTRIBUTES
          value: "instance_name=vm3,instance_role=app-c,region=region1"
