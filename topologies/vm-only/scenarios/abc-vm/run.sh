...
if [[ ${ACTION} = "deploy" ]]; then
  ...
  kubectl --context mgmt apply -f ${SCENARIO_ROOT_DIR}/k8s/mgmt/03-workload-group.yaml ;
  kubectl --context mgmt apply -f ${SCENARIO_ROOT_DIR}/k8s/mgmt/04-service.yaml ;
  kubectl --context mgmt apply -f ${SCENARIO_ROOT_DIR}/k8s/mgmt/05-onboarding-policy.yaml ;
  kubectl --context mgmt apply -f ${SCENARIO_ROOT_DIR}/k8s/mgmt/06-sidecar.yaml ;
  kubectl --context mgmt apply -f ${SCENARIO_ROOT_DIR}/k8s/mgmt/07-ingress-gateway.yaml ;
